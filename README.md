...
#### A guide covering Bayesian Statistics including the applications, libraries and tools that will make you better and more efficient with Bayesian Statistics development.
...
1. [Bayesian Statistics Learning Resources](https://github.com/mikeroyal/Bayesian-Statistics-Guide#Bayesian-Statistics-learning-resources)

2. [Bayesian Statistics Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Bayesian-Statistics-Guide#Bayesian-Statistics-tools-libraries-and-frameworks)

3. [Algorithms](https://github.com/mikeroyal/Bayesian-Statistics-Guide#Algorithms)

4. [Machine Learning](https://github.com/mikeroyal/Bayesian-Statistics-Guide#machine-learning)

5. [Deep Learning Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#Deep-Learning-Development)

6. [Reinforcement Learning Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#Reinforcement-Learning-Development)

7. [Computer Vision Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#computer-vision-development)

8. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#nlp-development)

9. [Distributed Computing](https://github.com/mikeroyal/Bayesian-Statistics-Guide#distributed-computing)

10. [Parallel Computing](https://github.com/mikeroyal/Bayesian-Statistics-Guide#parallel-computing)

11. [CUDA Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#cuda-development)

12. [MATLAB Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#matlab-development)

13. [Python Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#python-development)

14. [C/C++ Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#cc-development)

15. [R Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#r-development)

16. [Julia Development](https://github.com/mikeroyal/Bayesian-Statistics-Guide#julia-development)


# Bayesian Statistics Learning Resources
[Back to the Top](https://github.com/mikeroyal/Bayesian-Statistics-Guide#table-of-contents)

[Bayesian Statistics ](https://en.wikipedia.org/wiki/Bayesian_statistics) is a mathematical theory in the field of statistics based on the [Bayesian interpretation of probability](https://en.wikipedia.org/wiki/Bayesian_probability) where probability expresses a degree of belief in an event.

[Bayes' Theorem](https://en.wikipedia.org/wiki/Bayes'_theorem) is a theorem that describes the probability of an event, based on prior knowledge of conditions that might be related to the event.

[Bayesian Statistics |MATLAB](https://matlab1.com/bayesian-statistics/)

[Top Bayesian Statistics Courses Online | Coursera](https://www.coursera.org/courses?query=bayesian%20statistics)

[Top Bayesian Statistics Courses Online | Udemy](https://www.udemy.com/topic/bayesian-statistics/)

[Applied Bayesian for Analytics Course | edX](https://www.edx.org/course/applied-bayesian-for-analytics)

[Bayesian Statistics Course | Stanford Online](https://online.stanford.edu/courses/stats270-course-bayesian-statistics)

[Bayesian Statistics | Johns Hopkins Engineering Online](https://ep.jhu.edu/courses/625665-bayesian-statistics/)

[Bayesian Statistics Online Course | Duke University](https://online.duke.edu/course/bayesian-statistics/)

[Bayesian Statistics | MIT OpenCourseWare](https://ocw.mit.edu/courses/mathematics/18-650-statistics-for-applications-fall-2016/lecture-videos/lecture-17-video/)

[Bayesian Statistics (a very brief introduction) | Univeristy of Washington](http://faculty.washington.edu/kenrice/BayesIntroClassEpi2018.pdf)

[3 Basics of Bayesian Statistics | Carnegie Mellon University](http://www.stat.cmu.edu/~brian/463-663/week09/Chapter%2003.pdf)
...
# Bayesian Statistics Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Bayesian-Statistics-Guide#table-of-contents)

[Bayesian inference Using Gibbs Sampling(BUGS)](https://en.wikipedia.org/wiki/Bayesian_inference_using_Gibbs_sampling) is a software package commonly used for performing [Bayesian inference](https://en.wikipedia.org/wiki/Bayesian_inference) using [Markov chain Monte Carlo](https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo)

[Bayes Net Finder (BNFinder)](https://bioputer.mimuw.edu.pl/software/bnf/) is a toolbox allows for [Bayesian Network](https://en.wikipedia.org/wiki/Bayesian_network) reconstruction. It can be used for both dynamic and static networks.

[Bnlearn](https://www.bnlearn.com/) is an R package for learning the graphical structure of Bayesian networks, estimate their parameters and perform some useful inference.

[JASP](https://jasp-stats.org/) is an open-source statistics program that is free, friendly, and flexible.

[Stan](https://mc-stan.org/) is a C++ package providing full Bayesian inference using the No-U-Turn sampler (NUTS), a variant of Hamiltonian Monte Carlo (HMC),
approximate Bayesian inference using automatic differentiation variational inference (ADVI), and penalized maximum likelihood estimation (MLE) using L-BFGS optimization.

[GPflow](https://github.com/GPflow/GPflow) is a package for building Gaussian process models in Python. It implements modern Gaussian process inference for composable kernels and likelihoods.

[Turing.jl](https://turing.ml/) is a Julia library for general-purpose probabilistic programming. Turing allows the user to write models using standard Julia syntax, and provides a wide range of sampling-based inference methods for solving problems across probabilistic machine learning, Bayesian statistics, and data science.

[BAT.jl](https://github.com/bat/BAT.jl) is a Bayesian analysis toolkit in Julia that offers a variety of posterior sampling, mode estimation and integration algorithms, supplemented by plotting recipes and I/O functionality.

[PyTorch-BayesianCNN](https://github.com/kumar-shridhar/PyTorch-BayesianCNN) is a Bayesian convolutional neural networks with variational inference, a variant of convolutional neural networks (CNNs), in which the intractable posterior probability distributions over weights are inferred by Bayes by Backprop.

[Pingouin](https://pingouin-stats.org/) is an open-source statistical package written in Python 3 and based mostly on Pandas and NumPy.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Bayesian-Statistics-Guide/pulls).
